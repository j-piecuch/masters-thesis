...
\usepackage{minted, fancyvrb, epigraph, xurl, pifont, graphicx, multicol,
  threeparttable, booktabs, makecell, chngpage}
...
TODO
\subsection{Synchronization primitives}\label{chap:locking-intro}
...
include a lock which is protects access to at least some of its members. For
...
and \Verb{tetris} is fully playable on the Mimiker OS.
